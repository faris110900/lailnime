	...
	function publish(){
	    ...
	    if(!empty($_FILES['filefoto']['name'])){
	        if ($this->upload->do_upload('filefoto')){
				...
				$link1	  = $this->input->post('post_link_1');
				$link2	  = $this->input->post('post_link_2');
				...
				$this->post_model->save_post($title,$contents,$category,$slug,$link1,$link2,$image,$tags,$description);
	...
	function edit(){
	    ...
	    if(!empty($_FILES['filefoto']['name'])){
	        if ($this->upload->do_upload('filefoto')){
				...
				$this->post_model->edit_post_with_img($id,$title,$contents,$category,$slug,$link1,$link2,$image,$tags,$description);
			...
			$this->post_model->edit_post_no_img($id,$title,$contents,$category,$slug,$link1,$link2,$tags,$description);
			echo $this->session->set_flashdata('msg','info');
			redirect('backend/post');
		}
