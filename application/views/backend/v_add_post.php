                        ...
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input type="url" name="post_link_1" class="form-control" placeholder="Link Download 1" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="url" name="post_link_2" class="form-control" placeholder="Link Download 2" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
