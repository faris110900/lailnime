        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>LAILBLOG</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-inner">
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="post_link_1" class="form-control" value="<?php echo $b['post_link_1'];?>" placeholder="Link Download 1" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="post_link_2" class="form-control" value="<?php echo $b['post_link_2'];?>" placeholder="Link Download 2" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                ...
                <div class="page-footer">
                    <p class="no-s"><?php echo date('Y');?> &copy; Powered by Faris Rizqilail.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
