	...
	<section>
		<div class="container">
			...
			<div class="col-md-12 col-lg-8">
				...
				<h3 style="margin-top:-20px;"><b><?php echo $title;?></b></h3>

				<ul class="list-li-mr-20 mtb-15">
						<li>by <a href="#"><b style="color: red;"><?php echo $author;?> </b></a>, <?php echo date('d M Y',strtotime($date));?></li>
						<li><i class="mr-5 font-12 "></i><a class="text-danger" href="<?php echo site_url('category/'.$category_slug);?>"><b><?php echo $category;?></b></a></li>
					...
					<h2 class="mt-4"><b>SINOPSIS</b></h2>
					<div class="blog-post mt-2">
						<?php echo $content;?>
					<ul>
						<li>
							<a class="text-danger" target="blank" href="<?php echo prep_url($post_link_1);?>">Download <?php echo $title; ?> 720p</a>
						</li><br>

						<li>
							<a class="text-danger" target="blank" href="<?php echo prep_url($post_link_1);?>">Download <?php echo $title?> 480p</a>
						</li>
					</ul>
					</div>
					...
					<h4 class="p-title mt-50"><b>ANIME LAINNYA</b></h4>
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="text-dark"><b>Release :</b>
					...
					<h4 class="p-title mt-20"><b>KOMENTAR</b></h4>
					...
					<form class="form-block form-plr-15 form-h-45 form-mb-20 form-brdr-lite-white mb-md-50" method="post" action="<?php echo site_url('send_comment');?>">
						...
						<textarea class="ptb-10" name="comment" placeholder="Isi Komentar" required></textarea>
						<button class="btn plr-30" style="background-color: #000; color: #fff;" rows="4" cols="50" type="submit"><b>KOMENTAR</b></button>
					</form>
				</div><!-- col-md-9 -->
