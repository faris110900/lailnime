...
<head>
	...
	<!-- SEO Tags -->
    <meta name="description" content="Kumpulan Anime <?php echo $meta_description;?> dan banyak lagi..."/>
    ...
    <meta property="og:description" content="Kumpulan Anime <?php echo $meta_description;?> dan banyak lagi..." />
    ...
    <meta name="twitter:description" content="Kumpulan Anime <?php echo $meta_description;?> dan banyak lagi..." />
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<p><?php echo character_limiter($row->post_contents, );?></p>
								<li class="text-dark mt-2"><b>Release :</b>
						...
						<div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="<?php echo site_url('blog/'.$row->post_slug);?>">
								...
								<div class="ml-120 min-h-100x">
									...
									<h6 class="text-dark pt-10"><b>Release :</b> <?php echo date('d M Y',strtotime($row->post_date));?></h6>
								</div>
							</a><!-- oflow-hidden -->
							<?php endforeach;?>
